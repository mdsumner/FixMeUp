...
<H1>The Fixed Innovations Axle Explained</H1>
...
<TABLE>
<TR>
<TD><IMG SRC="./img/zhasDer.png" ALT="Chainpath with derailleur"
	BORDER="0" ALIGN = LEFT></TD>
<TD><IMG SRC="./img/znoDer.png" ALT="Chainpath without derailleur"
...
<CENTER><TABLE><TR>
<TD><IMG SRC="./img/zverdrop.png" ALT="vertical dropout" 
	BORDER="0" ALIGN = RIGHT></TD>
<TD><IMG SRC="./img/zhordrop.png" ALT="horizontal dropout" 
	BORDER="0" ALIGN = LEFT></TD>
</TR></TABLE></CENTER>
<P>Unfortunately, they also prevent you from adjusting the distance
...
<P> Whether a bike has vertical or horizontal dropouts, the slot for
...
<CENTER><TABLE><TR>
<TD><IMG SRC="./img/zaxle1.png" ALT="FI axle view 1" BORDER="0"></TD>
<TD><IMG SRC="./img/zaxle2.png" ALT="FI axle view 2" BORDER="0"></TD>
</TR></TABLE></CENTER>
...
<P> Here are a couple of small screen shots from the <a
href="javafmu.php">Java version</a> of <EM>FixMeUp!</EM>.  The light
...
<CENTER><TABLE><TR>
<TD><IMG SRC="./img/fmuvert.png" ALT="Chart with vert. drop" BORDER="0"></TD>
<TD><IMG SRC="./img/fmuwithaxle.png" ALT="Chart with FI axle" BORDER="0"></TD>
</TR></TABLE></CENTER>

<P>
The region you get without the axle is only about 1/4 the size.
Check out one of the versions of <A HREF="fixmeup.php"><EM>FixMeUp!</EM></A>
