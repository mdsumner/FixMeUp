...
<P>Here you'll find information about the <A HREF="#fi_axle">axles</A>, <A
HREF="#beye_hubs">Bullseye</A> and <A HREF="#phil_hubs">Phil Wood</A>
hubs available through Fixed Innovations.  </P>

<P>For pricing, and to order, see our <A HREF="order.php">orders
page</A>.</P>
...
<P>Flange spacing on our Bullseye hubs is 52mm. This lines 
both cogs up perfectly with most small chainrings; if you want to use 
one cog with the big ring and the other with the small you'll want to 
respace the hub slightly so that each cog is about 4mm inboard of the 
...
practice, and particularly not with gears above 65&quot; or so, but you 
should be aware of it. Don't even think of using one of these hubs on 
a bike without two working brakes -- not that that's a good idea 
under any circumstances!  And use Loctite rather than antisieze when 
installing the cogs.</P>


<A HREF="order.php">Prices</A>
